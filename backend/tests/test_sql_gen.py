...
from app.sql_gen import add_column_sql, alter_table_comment_sql
...
def test_alter_table_comment_sql():
    sql = alter_table_comment_sql("t", "你好'世界")
    assert sql == "ALTER TABLE `t` COMMENT='你好\\'世界'"
